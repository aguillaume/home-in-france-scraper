...
class Orpi extends Scraper {
    ...
    async scrapeData() {
        ...
        propertiesHtml.each((i, el) => {
            let property = {};
            property.link = this.baseUrl + $(el).find("a.u-link-unstyled.c-overlay__link").attr("href");
